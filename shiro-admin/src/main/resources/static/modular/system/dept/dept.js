...
Dept.initColumn = function () {
    return [
        ...
        {title: '上级ID', field: 'pid', visible: false, align: 'center', valign: 'middle', width: '50px'},
...
Dept.openEditPage = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/dept/edit/' + Dept.seItem.id
        });
        this.layerIndex = index;
    }
};
