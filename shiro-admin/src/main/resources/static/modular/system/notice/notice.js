 ...
 * @param val 数据的具体值
 */
Notice.set = function (key, value) {
    this.queryData[key] = (typeof value == "undefined") ? $("#" + key).val() : value;
    return this;
}
 ...
 * 收集数据
 */
Notice.collectData = function () {
    this.clearData();
    this.set('content').set('title');
}
...
Notice.search = function () {
    Notice.collectData();
    Notice.table.refresh({query: Notice.queryData});
};
...
Notice.initColumn = function () {
    return [
        ...
        {
            title: '内容(html格式)', field: 'content', align: 'center', valign: 'middle', sortable: true
        },
