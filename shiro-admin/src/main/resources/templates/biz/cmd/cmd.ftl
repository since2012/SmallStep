...
<head>
    ...
    <script src="/static/modular/biz/cmd/cmd.js"></script>
</head>
<body>
...
<section class="content">
                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <label for="detail" class="col-md-2 col-lg-1 control-label"
                    ...
                    <div class="box-footer text-center">
                        <button type="button" onclick="Command.search()" class="btn btn-primary btn-sm no-margin-top">
                            <i class="fa fa-check"></i> 查询
                        </button>
                        <button type="button" onclick="Command.reset();" class="btn btn-default btn-sm no-margin-top">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-body">
                    <div class="hidden-xs" id="cmdTableToolbar" role="group">
                        <button type="button" onclick="Command.openAddPage()"
                                class="btn btn-success btn-sm no-margin-top">
                            新增
                        </button>
                        <button type="button" onclick="Command.openEditPage()"
                                class="btn btn-warning btn-sm no-margin-top">
                            编辑
                        </button>
                        <button type="button" onclick="Command.delete()" class="btn btn-default btn-sm no-margin-top">
                            删除
                        </button>
                    </div>
                    <table id="cmdTable" data-mobile-responsive="true" data-click-to-select="true">
                        <thead>
                        <tr>
