    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="box">
            <div class="form-horizontal bv-form" id="sellerInfoForm" novalidate="novalidate">
                ...
                <input type="hidden" id="id" value="${seller.id}">
                <input type="hidden" id="statusVal" value="${seller.status}">
                <div class="row">
                    <div class="col-xs-6 b-r">
                        <div class="form-group has-feedback">
                            <label class="col-xs-3 control-label">卖家名称</label>
                            <div class="col-xs-9">
                                <input class="form-control" id="name" name="name" type="text" value="${seller.name}">
                            </div>
                        </div>
                        <div class="form-group has-feedback has-error">
                            <label class="col-xs-3 control-label">卖家地址</label>
                            <div class="col-xs-9">
                                <input class="form-control" id="addr" name="addr" type="text" value="${seller.addr}">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="row btn-group-m-t">
                    <div class="text-center">
                        <button type="button" class="btn btn-info " onclick="SellerInfo.editSubmit()" id="ensure">
