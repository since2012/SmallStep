...
<head>
    ...
    <script src="/static/modular/biz/stock/show.js"></script>
</head>
<body>
            ...
            <div class="box box-success">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="box-footer text-center">
                        <button type="button" onclick="Show.search()" class="btn btn-primary btn-sm no-margin-top">
                            <i class="fa fa-check"></i> 查询
                        </button>
                        <button type="button" onclick="Show.reset();" class="btn btn-default btn-sm no-margin-top">
