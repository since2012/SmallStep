                ...
                <div class="row">
                    <div class="col-xs-6 b-r">
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" id="name" name="name" type="text" data-bv-field="name"><i
                                    class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" id="code" name="code" type="text" data-bv-field="code"><i
                                    class="form-control-feedback" data-bv-icon-for="code" style="display: none;"></i>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" id="url" name="url" type="text" data-bv-field="url"><i
                                    class="form-control-feedback" data-bv-icon-for="url" style="display: none;"></i>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" id="num" name="num" type="text" data-bv-field="num"><i
                                    class="form-control-feedback" data-bv-icon-for="num" style="display: none;"></i>
