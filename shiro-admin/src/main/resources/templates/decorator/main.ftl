                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/mgr/profile" class="btn btn-default btn-flat">个人资料</a>
                                </div>
...
<#--页脚-->
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            base on <b>AdminLTE </b>Version 2.4.0
        </div>
    </footer>
                ...
                <ul class="control-sidebar-menu">
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">Frodo更新了个人资料</h4>
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">Nora加入了邮寄列表</h4>
